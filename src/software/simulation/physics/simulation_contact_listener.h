...
class SimulationContactListener : public b2ContactListener
{
   public:
     ...
     * between a ball and robot mouth. Otherwise returns std::nullopt
     *
     ...
     * was a contact between a ball and robot mouth, and returns std::nullopt
     * otherwise
     */
    static std::optional<std::pair<PhysicsBall*, PhysicsRobot*>> isBallMouthContact(
     ...
     */
    staticPhysicsBall* isBallContact(PhysicsObjectUserData* user_data_a,
